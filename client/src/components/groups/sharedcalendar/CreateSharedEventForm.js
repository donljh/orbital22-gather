...
const CreateSharedEventForm = (props) => {
  ...
  const createNewEvent = async () => {
    ...
    axiosRes.post(`/group/${groupID}/sharedevents`, event)
      .then(response => {
    ...
    <Box sx={formStyle}>
      <form>
        <Stack mb={4} spacing={4}>
          <Typography variant="h6" textAlign='center'>Creating A Shared Event</Typography>
          <TextField
            name="title"
            value={title}
...
export default CreateSharedEventForm;